...
3. [Cell-type annotation on scST data (without pre-annotated info)](./Tutorials/Tutorial2_cell-type_annotation_on_scST_data_(without_pre-annotated_info).ipynb).

4. [Reannotation on scST data (with pre-annotated info)](./Tutorials/Tutorial3_reannotation_on_scST_data_(with_pre-annotated_info).ipynb).

5. [Unknown cell type detection](./Tutorials/Tutorial4_unknown_cell_type_detection.ipynb).

6. [Gene module extraction](./Tutorials/Tutorial5_gene_module_extraction.ipynb).
